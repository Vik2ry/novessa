...
export const fallbackSite: SitePayload = {
  ...
  donationTiers: [
    {
      amount: 5000,
      label: "Basic",
      impact: "Supply school kits for 2 children",
    },
    {
      amount: 15000,
      label: "Impact",
      impact: "Provide 30 hot meals this month",
    },
    {
      amount: 50000,
      label: "Hero",
      impact: "Fund counseling and outreach sessions",
    },
    {
      amount: 100000,
      label: "Legacy",
      impact: "Support vocational training grants",
    },
  ],
  contact: {
    ...
    socials: [
      ...
      {
        label: "LinkedIn",
        href: "https://linkedin.com/company/novessafoundation",
      },
  ...
  footer: {
    summary:
      "Empowering Nigerian communities through sustainable impact and radical empathy.",
    quickLinks: [
      { label: "About Us", href: "/about" },
      { label: "Programs", href: "/programs" },
      { label: "Impact", href: "/impact" },
  ...
  programs: [
        ...
        howItWorks: [
          {
            ...
            body: "Awareness sessions led with schools, faith leaders, and local advocates.",
          },
          {
            title: "Safe Access",
            body: "Confidential counseling entry points online and in person.",
          },
          {
            title: "Direct Counseling",
            body: "Subsidized support for individuals needing more sustained care.",
          },
        ],
        gallery: [
    ...
    },
    {
      ...
      summary:
        "Removing financial barriers through school fees support, supplies, and mentorship.",
    ...
    },
    {
      ...
      summary:
        "Practical training in digital, technical, and leadership skills for independent futures.",
    ...
    },
    {
      ...
      title: "Community Outreach",
      summary:
        "School, rural, and neighborhood outreach that opens conversation and connects people to care.",
    ...
    },
    {
      ...
      summary:
        "Resources and guidance for neurodivergent people, families, and educators.",
    ...
    },
    {
      ...
      summary:
        "Mentoring, confidence-building, and leadership pathways for women and girls.",
  ...
  stories: [
    ...
    },
    {
      ...
      summary:
        "Five school clusters now have reading materials, teacher support, and peer-led learning circles.",
    ...
    },
    {
      ...
      summary:
        "Community-managed boreholes are cutting illness rates and travel time for women and children.",
      body: "This story traces a local partnership model that keeps water access community-owned and maintained.",
      category: "Sustainability",
      imageUrl:
        "https://images.unsplash.com/photo-1495555687392-47f9e1f88b5e?auto=format&fit=crop&w=1200&q=80",
      featured: false,
      metadata: {
        readTime: "8 min read",
        authorName: "Samuel Bankole",
    ...
    },
    {
      ...
      summary:
        "A new cohort of trainees is turning creative and technical skills into steady work.",
  ...
  campaigns: [
    {
      ...
      summary:
        "Fund outreach, counseling pathways, school support, and practical care resources.",
      ...
      metadata: {
        messageToDonors:
          "Your generosity fuels sustainable change across Nigeria.",
        monthlyPlans: [
          {
            name: "Seed Partner",
            amount: 2500,
            description: "Plant the foundation of change.",
          },
          {
            name: "Harvest Partner",
            amount: 10000,
            description: "Fuel active programs month after month.",
          },
          {
            name: "Legacy Partner",
            amount: 50000,
            description: "Help fund large-scale, long-term work.",
          },
        ],
      },
    },
  ...
  partners: [
    {
      ...
      summary:
        "Helping power transparent giving infrastructure and donor stewardship systems.",
      ...
      featured: true,
      metadata: {
        categoryLabel: "Financial Inclusion",
        ctaLabel: "Banking Partner",
      },
    },
    {
      id: 4002,
      ...
      summary:
        "Enabling smoother donation experiences and digital transaction confidence.",
    ...
    },
    {
      ...
      summary:
        "Supporting warehousing, field delivery, and local distribution logistics.",
    ...
    },
    {
      ...
      summary:
        "Collaborating on referral systems, workshops, and local clinical guidance.",
...
export async function getSitePayload(): Promise<SitePayload> {
  ...
  try {
    const response = await fetch(`${baseUrl}/content/site/`, {
      next: { revalidate: 60 },
    });
...
export async function getContentItem(
  ...
  const fallbackItem =
    fallbackSite[
      `${contentType === "story" ? "stories" : `${contentType}s`}` as keyof SitePayload
    ];
  const fallbackMatch = Array.isArray(fallbackItem)
    ? ((fallbackItem as ContentItem[]).find((item) => item.slug === slug) ??
      null)
    : null;
  ...
  try {
    const response = await fetch(`${baseUrl}/content/${contentType}/${slug}/`, {
      cache: "no-store",
    });
...
export async function getDonation(
  ...
  try {
    const response = await fetch(`${baseUrl}/donations/${reference}/`, {
      cache: "no-store",
    });
